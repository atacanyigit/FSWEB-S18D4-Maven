...
import com.workintech.s18d1.S18d1Application;
...
@ContextConfiguration(classes = {S18d1Application.class})
class ApplicationPropertiesAndControllerTest {
    ...
    void testBurgerNotFoundException() throws Exception {
        ...
        mockMvc.perform(get("/burger/{id}", 1))
    ...
    void testGenericException() throws Exception {
        ...
        mockMvc.perform(get("/burger/{id}", 2))
    ...
    void testUpdateBurger() throws Exception {
        ...
        mockMvc.perform(put("/burger/{id}", updatedBurger.getId())
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void testFindByBreadType() throws Exception {
        ...
        mockMvc.perform(get("/burger/findByBreadType")
    ...
    void testFindByPrice() throws Exception {
        ...
        mockMvc.perform(get("/burger/findByPrice")
    ...
    void testFindByContent() throws Exception {
        ...
        mockMvc.perform(get("/burger/findByContent")
